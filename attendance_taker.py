...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Face Recognizer for Intruder Detection", (20, 40), self.font, 1, (255, 255, 255), 1, cv2.LINE_AA)
        ...
        for i in range(len(self.current_frame_face_name_list)):
            img_rd = cv2.putText(img_rd, "Verified_Face_" + str(i + 1), tuple(
    ...
    def attendance(self, name):
        ...
        if existing_entry:
            print(f"{name} is already Verified and present for {current_date}")
        else:
